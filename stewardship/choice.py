...
ANTIBIOTIC_CHOICES = [("Ampicillin", "Ampicillin"),
...
# Resistance Choices
RESISTANCE_CHOICES = [("CRE( Carbapenemase resistant enterobactereciae)", "CRE( Carbapenemase resistant enterobactereciae)"),
...
("VRE(Vancomycin resistant enterococcus)", "VRE(Vancomycin resistant enterococcus)"),
("CRAB( Carbapenem resistant acinetobacter baumannii)", "CRAB( Carbapenem resistant acinetobacter baumannii)"),
